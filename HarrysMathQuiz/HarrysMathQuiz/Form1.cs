...
namespace HarrysMathQuiz
{
    public partial class Form1 : Form
    {
        ...
        private void soundSum(object sender, EventArgs e)
        {
            NumericUpDown answerBox = sender as NumericUpDown;
        ...
        private void soundDifference(object sender, EventArgs e)
        {
            NumericUpDown answerBox = sender as NumericUpDown;
        ...
        private void soundProduct(object sender, EventArgs e)
        {
            NumericUpDown answerBox = sender as NumericUpDown;
        ...
        private void soundQuotient(object sender, EventArgs e)
        {
            NumericUpDown answerBox = sender as NumericUpDown;
